...
$tipocargo = strtoupper(filter_input(INPUT_POST,"tipocargo"));
$tipobeneficio = strtoupper(filter_input(INPUT_POST,"tipobeneficio"));
...
$sql = "INSERT INTO associados(nome, endereco, telefone, celular, rg, cpf, email, datanascimento, fktipodeficiencia, fktipoassociado, fktipocargo, fktipobeneficio, dataadmissao) VALUES ('$nome', '$endereco', '$telefone', '$celular', '$rg', '$cpf', '$email', '$datanascimento', '$tipodeficiencia', '$tipoassociado', '$tipocargo', '$tipobeneficio', '$dataadmissao')";
